...
static ID *link_named_part_ex(Main *mainl,
                              FileData *fd,
...
{
  FileData *fd = (FileData *)(*bh);
  return link_named_part_ex(mainl, fd, NULL, NULL, idcode, name, NULL, flag);
}
 ...
 * \return the linked ID when found.
 */
struct ID *BLO_library_link_named_part_asset(Main *mainl,
                                             BlendHandle **bh,
                                             const AssetEngineType *aet,
                                             const char *root,
                                             const short idcode,
...
{
  FileData *fd = (FileData *)(*bh);
  return link_named_part_ex(mainl, fd, aet, root, idcode, name, uuid, flag);
}
