                                    ...
                                    short sort)
{
  ...
  if (flag &
      (WM_FILESEL_DIRECTORY | WM_FILESEL_FILEPATH | WM_FILESEL_FILENAME | WM_FILESEL_FILES)) {
  ...
  if (flag &
    ...
    if (flag & (WM_FILESEL_FILEPATH | WM_FILESEL_FILENAME)) {
      prop = RNA_def_int_vector(ot->srna,
                                ...
                                INT_MAX,
                                "Repository UUID",
                                "Identifier of this item's repository in current asset engine",
                                INT_MIN,
                                INT_MAX);
      RNA_def_property_flag(prop, PROP_HIDDEN | PROP_SKIP_SAVE);
      prop = RNA_def_int_vector(ot->srna,
                                ...
                                INT_MAX,
                                "Asset UUID",
                                "Identifier of this item in current asset engine",
                                INT_MIN,
                                INT_MAX);
      RNA_def_property_flag(prop, PROP_HIDDEN | PROP_SKIP_SAVE);
      prop = RNA_def_int_vector(ot->srna,
                                ...
                                INT_MAX,
                                "Variant UUID",
                                "Identifier of this item's variant in current asset engine",
                                INT_MIN,
                                INT_MAX);
      RNA_def_property_flag(prop, PROP_HIDDEN | PROP_SKIP_SAVE);
      prop = RNA_def_int_vector(ot->srna,
                                ...
                                INT_MAX,
                                "Revision UUID",
                                "Identifier of this item's revision in current asset engine",
                                INT_MIN,
                                INT_MAX);
      RNA_def_property_flag(prop, PROP_HIDDEN | PROP_SKIP_SAVE);
      prop = RNA_def_int_vector(ot->srna,
                                ...
                                INT_MAX,
                                "View UUID",
                                "Identifier of this item's view in current asset engine",
                                INT_MIN,
                                INT_MAX);
      RNA_def_property_flag(prop, PROP_HIDDEN | PROP_SKIP_SAVE);
    }
