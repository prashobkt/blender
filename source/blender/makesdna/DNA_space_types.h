...
#define INFO_CLOG_FORMAT_DEFAULT \
  INFO_CLOG_SHOW_LEVEL | INFO_CLOG_SHOW_LOG_TYPE | INFO_CLOG_SHOW_FILE_LINE | \
      INFO_CLOG_SHOW_FUNCTION | INFO_CLOG_USE_MESSAGE_NEW_LINE | INFO_CLOG_USE_SHORT_FILTE_LINE
