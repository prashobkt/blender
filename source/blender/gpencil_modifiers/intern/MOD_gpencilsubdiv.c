...
{
  PanelType *panel_type = gpencil_modifier_panel_register(region_type, "Subdivide", panel_draw);
  gpencil_modifier_subpanel_register(
      region_type, "subdivide_mask", "Influence", NULL, mask_panel_draw, panel_type);
}
